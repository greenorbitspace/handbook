...
description: The Security Research team contributes to the Security Vision and Mission
  through projects that focus on identifying, quantifying, and developing solutions
  for complex security risks facing GitLab and its users.
weight: 2
date: '2025-06-12'
linkTitle: Security Research
type: docs
---
