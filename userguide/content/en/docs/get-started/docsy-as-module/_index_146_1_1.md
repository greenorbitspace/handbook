...
description: The Fulfillment Sub-department is composed of the Billing and Subscription
  Management, Fulfillment Platform, Provision, and Utilization development teams working
  on the infrastructure between the systems which affect the user purchasing process
  that support the GitLab DevOps Platform.
weight: 2
date: '2025-06-12'
aliases:
- /docs/_index_146_1_1/
linkTitle: Fulfillment Sub-department
type: docs
---
