...
description: An overview of Adoption Scoring, how it is calculated, and how CSMs can
  use the information with customers in their conversations.
weight: 2
date: '2025-06-12'
aliases:
- /docs/maturity-scoring_1_1/
linkTitle: Use Case Adoption Scoring
type: docs
---
