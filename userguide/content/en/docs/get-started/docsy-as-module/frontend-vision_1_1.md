...
description: Write guidelines about frontend architecture practices we want to have
  on GitLab frontend in three years
status: active
weight: 2
date: '2025-06-12'
aliases:
- /docs/frontend-vision_1_1/
linkTitle: Frontend Vision Group
type: docs
---
