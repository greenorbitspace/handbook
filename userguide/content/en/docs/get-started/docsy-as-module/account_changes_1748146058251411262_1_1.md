...
description: Workflow for responding to requests to make changes or take action on
  behalf of a GitLab.com user
weight: 2
date: '2025-06-12'
aliases:
- /docs/account_changes_1748146058251411262_1_1/
linkTitle: Making Changes and Taking Actions on a user's behalf
type: docs
---
