...
description: This page describes the process and technical documentation around blocking
  end-to-end tests at GitLab. Blocking tests are executed as a showstopper step in
  the release pipelines. Blocking tests are executed as a blocking step in MRs but
  not the deployments.
weight: 2
date: '2025-06-12'
aliases:
- /docs/blocking-tests_1_1/
linkTitle: Blocking end-to-end tests
type: docs
---
