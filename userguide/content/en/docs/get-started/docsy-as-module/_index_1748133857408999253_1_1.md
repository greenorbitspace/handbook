...
description: Identity and Access Management (IAM) and Role-Based Access Control (RBAC)
  is a shared responsibility across several teams at GitLab. This page has a directory
  of all of our stable counterparts.
weight: 2
date: '2025-06-12'
aliases:
- /docs/_index_1748133857408999253_1_1/
linkTitle: Identity Counterparts
type: docs
---
