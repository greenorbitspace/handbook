...
description: Describes the external GitLab Projects used by the Distribution Team,
  how to handle MRs from these, and resources for Renovate maintenance and new dependency
  addition.
weight: 2
date: '2025-06-12'
aliases:
- /docs/renovate_1/
linkTitle: Distribution Team usage of Renovate
type: docs
---
