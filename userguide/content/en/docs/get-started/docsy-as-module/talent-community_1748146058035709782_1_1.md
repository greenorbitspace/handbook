...
description: The Talent Acquisition Process Framework for Talent Pools provides guidance
  on the talent pool process so the talent acquisition team can efficiently build
  a talent bench before we need it.
weight: 2
date: '2025-06-12'
aliases:
- /docs/talent-community_1748146058035709782_1_1/
linkTitle: GitLab Talent Acquisition Process Framework for Talent Pools
type: docs
---
