...
description: The Security Policies team at GitLab is responsible for creating solutions
  that enforce scans, and require security approvals once vulnerabilities are detected.
layout: single
weight: 2
date: '2025-06-12'
aliases:
- /docs/_index_142_1_1/
linkTitle: Software Supply Chain Security, Security Policies
type: docs
---
