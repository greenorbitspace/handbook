...
description: Email database management is a core responsibility for MktgOps. Ensuring
  GitLab is following email best practices, in compliance with Global spam laws and
  overall health of active database are all priorities.
weight: 2
date: '2025-06-12'
aliases:
- /docs/_index_1748133863640109534_1_1/
