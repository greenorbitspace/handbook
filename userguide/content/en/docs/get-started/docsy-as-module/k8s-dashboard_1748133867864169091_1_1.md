...
description: Project plan for providing customer a complete dashboard to visualize
  the status of their cluster
weight: 2
date: '2025-06-12'
aliases:
- /docs/k8s-dashboard_1748133867864169091_1_1/
