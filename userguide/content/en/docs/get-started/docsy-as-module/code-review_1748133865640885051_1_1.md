...
description: Code reviews are mandatory for every merge request, you should get familiar
  with and follow our Code Review Guidelines specific to GitLab Marketing projects.
weight: 2
date: '2025-06-12'
aliases:
- /docs/code-review_1748133865640885051_1_1/
linkTitle: DEX Code Review Guidelines
type: docs
---
